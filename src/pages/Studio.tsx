  ...
  return (
    <div className="w-full h-full bg-[#0a0a0a] flex">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header className="h-14 bg-[#111111] border-b border-white/[0.04] flex-shrink-0 flex items-center justify-between px-6">
            ...
            <div className="flex items-center gap-2">
                ...
                <button onClick={handleExportAndPublish} className={`px-4 py-2 text-sm rounded-lg text-white font-semibold transition-colors disabled:bg-emerald-800 disabled:cursor-not-allowed ${isEmailConfirmed ? 'bg-emerald-500 hover:bg-emerald-600' : 'bg-yellow-500 hover:bg-yellow-600'}`} disabled={!media}>
                    {isEmailConfirmed ? 'Publish' : 'Confirm Email to Publish'}
                </button>
            </div>
        </header>
      ...
      <ConfirmationModal 
        ...
        message="To prevent spam and ensure the quality of our community, we require all users to confirm their email address before they can publish content."
